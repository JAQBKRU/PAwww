...
<script>
    ...
    expandButtons.forEach((button) => {
        button.addEventListener('click', function () {
            // Szukamy elementu subcategory-list w obrębie rodzica przycisku
            const subcategoryList = this.parentElement.querySelector('.subcategory-list');
            
            if (subcategoryList) {  // Jeśli element istnieje, wykonujemy kod
                // Toggle visibility podkategorii
                if (subcategoryList.style.display === 'none' || subcategoryList.style.display === '') {
                    subcategoryList.style.display = 'block';
                    this.textContent = 'Zwiń'; // Zmiana tekstu przycisku na 'Zwiń'
                } else {
                    subcategoryList.style.display = 'none';
                    this.textContent = 'Rozwiń'; // Zmiana tekstu przycisku na 'Rozwiń'
                }
            } else {
