...
function UsunPodstrone($id){
    ...
    if (isset($id) && is_numeric($id)) {
        ...
        if (mysqli_query($link, $qry)) {
            ...
            header("Location: panel.php?action=add_subpage"); // Przekierowanie na stronę z listą podstron
            exit();
        } else {
...
if (isset($_GET['action'])) {
    ...
    switch ($action) {
        ...
        case 'products':
            ...
            // if (isset($_GET['action']) && $_GET['action'] == 'products' || true) {
            //     global $zarzadzajProduktami;
        ...
        //         if (isset($_GET['id'])) {
        //             $zarzadzajProduktami = new ZarzadzajProduktami($link);
        //             $zarzadzajProduktami->EdytujProdukt($_GET['id'], $_POST['tytul'], $_POST['opis'], $_POST['data_wygasniecia'], $_POST['cena_netto'], $_POST['podatek_vat'], $_POST['ilosc_magazyn'], $_POST['status_dostepnosci'], $_POST['kategoria'], $_POST['gabaryt_produktu'], $_POST['zdjecie']);
        //         }
        //         break;
        //     case 'delete_product':
        //         if (isset($_GET['id'])) {
        //             $zarzadzajProduktami = new ZarzadzajProduktami($link);
        //             $zarzadzajProduktami->UsunProdukt($_GET['id']);
        //         }
        //        break;
        }
    }
...
if (isset($_GET['edit_product_id'])) {
    // Edytowanie produktu na podstawie ID
    $zarzadzajProduktami->formularzEdycji($_GET['edit_product_id']);
}

if (isset($_GET['delete_product_id'])) {
    // Usuwanie produktu na podstawie ID
    $zarzadzajProduktami->UsunProdukt($_GET['delete_product_id']);
}
