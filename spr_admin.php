...
function DodajNowaPodstrone() {
    ...
    <form method="POST" action="">
        ...
        <input type="submit" name="save_changes" value="Dodaj nowa podstrone">
    </form>
    ';
    ...
    if (isset($_POST['save_changes'])) {
        ...
        $qry = "INSERT INTO page_list (id, page_title, page_content, status) VALUES (null, '$new_title', '$new_content', '$new_status');";
        
        if(isset($_POST['title']) && isset($_POST['content']) && !is_null($_POST['title']) && !is_null($_POST['content'])){
            $result = mysqli_query($link, $qry);
            echo "title: ".$_POST['title'];
            echo "content: ".$_POST['content'];
            
            echo "Dodany nowa podstrone!";
            unset($_POST['title']);
            unset($_POST['content']);
            unset($_POST['status']);
        }else{
            echo "Błąd podczas dodawania nowej podstrony: " . mysqli_error($link);
        }
